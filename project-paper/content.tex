...
containers or nodes to scale up the deployment. Heroku manages all of these
...
besides it is then deployed using Dockerfile. For Deployment to Heroku, we need 
three files.
\begin{itemize}
