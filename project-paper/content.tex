...
\section{Regression Results}
 ...
 Results can be compared between \ref{tab:PredMPG} and \ref{tab:TestSetMPG}. 
 The first \ref{tab:TestSetMPG} lists highway mpg with engine size from our
 test\_set data while \ref{tab:PredMPG} shows an array of predicted highway mpg. 
 ...
 from model over scatter plot from test set~\ref{p:predplt}. The plot shows 
